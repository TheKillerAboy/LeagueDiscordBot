...
def lolchampion(username,gateway,req_size,championId,channelId):
    ...
    client.loop.create_task(general.league_champion_embed_data_get(DATABASE,username,gateway,client.get_channel(channelId),championId,queue=req_size,api_stack=2))
    return '''<!DOCTYPE HTML>
<HTML>
   <HEAD>
